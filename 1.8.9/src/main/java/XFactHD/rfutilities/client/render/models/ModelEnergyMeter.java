...
package XFactHD.rfutilities.client.render.models;
...
public class ModelEnergyMeter extends ModelBase
{
    ...
    private ModelRenderer WireLeftHorizontal;
    private ModelRenderer WireRightHorizontal;
    private ModelRenderer WireLeftVertical;
    private ModelRenderer WireRightVertical;
    private ModelRenderer DisplayCorpus;
    private ModelRenderer DisplayFrameRight;
    private ModelRenderer DisplayFrameLeft;
    private ModelRenderer DisplayFrameBottom;
    private ModelRenderer DisplayFrameTop;
    private ModelRenderer DisplayCon1;
    private ModelRenderer DisplayCon2;
    private ModelRenderer DisplayCon3;
    private ModelRenderer DisplayCon4;
    private ModelRenderer DisplayCon5;
    private ModelRenderer DisplayWindow;
