...
public class ModelSwitchFloat extends ModelBase
{
  //fields
    ...
    ModelRenderer SwitchCasing;
    ModelRenderer LEDBack;
    ModelRenderer LEDFront;
    public ModelRenderer LeverLeft;
    public ModelRenderer LeverRight;
  
  public ModelSwitchFloat()
  {
    textureWidth = 64;
    textureHeight = 64;
      ...
      SwitchCasing.setRotationPoint(-6F, 13F, -3F);
      ...
      LEDBack.setRotationPoint(-1F, 15F, 3F);
      ...
      LEDFront.setRotationPoint(-1F, 15F, -4F);
      ...
      LeverLeft.setRotationPoint(0.5F, 12F, -2F);
      ...
      LeverRight.setRotationPoint(0F, 12F, -2F);
