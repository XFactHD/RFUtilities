...
public class RFUTeslaHandlerResistor implements ITeslaProducer, ITeslaConsumer
{
    private TileEntityResistor resistor;
    private EnumFacing side = null;

    public RFUTeslaHandlerResistor(TileEntityResistor resistor)
    {
        this.resistor = resistor;
    }

    public RFUTeslaHandlerResistor setSendingSide(EnumFacing side)
    {
        this.side = side;
        return this;
    }
    ...
    public long givePower(long amount, boolean simulate)
    {
        ...
        return resistor.transferEnergy(side, (int)amount, simulate);
    }
