...
public class ItemRendererRFMeter implements IItemRenderer
{
    ModelEnergyMeter model = new ModelEnergyMeter();

    @Override
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ResourceLocation texture = new ResourceLocation(Reference.MOD_ID + ":textures/models/modelEnergyMeter.png");
        switch (type)
        {
            case INVENTORY:
                GL11.glPushMatrix();
