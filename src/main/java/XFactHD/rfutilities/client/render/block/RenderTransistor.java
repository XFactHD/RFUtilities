...
public class RenderTransistor extends TileEntitySpecialRenderer
{
    private ModelTransistor model;

    public RenderTransistor()
    {
        this.model = new ModelTransistor();
    }
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale)
    {
        ...
        final ResourceLocation textureLocation = new ResourceLocation(Reference.MOD_ID.toLowerCase(), "textures/models/modelTransistor" + (((TileEntityTransistor)te).getIsOn() ? "On" : "Off") + ".png");
