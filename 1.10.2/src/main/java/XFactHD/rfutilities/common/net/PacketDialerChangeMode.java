...
public class PacketDialerChangeMode implements IMessage
{
    ...
    public static class Handler implements IMessageHandler<PacketDialerChangeMode, IMessage>
    {
        @Override
        public IMessage onMessage(PacketDialerChangeMode message, final MessageContext ctx)
        {
            FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(new Runnable()
            {
                ...
                private void handle(final MessageContext ctx)
                {
