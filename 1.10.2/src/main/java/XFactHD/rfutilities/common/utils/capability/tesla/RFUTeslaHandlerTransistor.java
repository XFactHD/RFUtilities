...
public class RFUTeslaHandlerTransistor implements ITeslaProducer, ITeslaConsumer
{
    private TileEntityTransistor transistor;
    private EnumFacing side = null;

    public RFUTeslaHandlerTransistor(TileEntityTransistor transistor)
    {
        this.transistor = transistor;
    }

    public RFUTeslaHandlerTransistor setSendingSide(EnumFacing side)
    {
        this.side = side;
        return this;
    }
    ...
    public long givePower(long amount, boolean simulate)
    {
        ...
        return transistor.transferEnergy(side, (int)amount, simulate);
    }
